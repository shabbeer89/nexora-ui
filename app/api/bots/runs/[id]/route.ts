...
export async function GET(
    ...
    try {
        ...
        const response = await fetch(`${API_URL}/bot-orchestration/bot-runs/${id}`, {
        ...
        if (!response.ok) {
            ...
            return NextResponse.json(
                { error: error.detail || 'Failed to fetch bot run' },
        ...
        console.error('Error fetching bot run:', error);
        return NextResponse.json(
